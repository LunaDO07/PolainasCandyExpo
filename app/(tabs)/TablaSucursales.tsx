...
const handleSave = () => {
    if (validateFields(selectedItem)) {
        ...
        setEmptyFieldsMessage('Existen campos vacíos. Por favor, completa toda la información');
...
const handleAddProduct = () => {
    if (validateFields(newItem)) {
        ...
        setEmptyFieldsMessage('Por favor, complete todos los campos.');
        setEmptyFieldsModalVisible(true);
    }
};
...
return (
    <View style={styles.container}>
        ...
        >
            ...
            {/* modal de verificacion de campos vacios */}
        <Modal
        ...
        >
            <View style={styles.emptyFieldsModalOverlay}>
                <View style={styles.emptyFieldsModalContent}>
                <Ionicons name="alert-circle-outline" size={40} color="#000000" />
                    <Text style={styles.emptyFieldsModalMessage}>{emptyFieldsMessage}</Text>
                    <TouchableOpacity  onPress={() => setEmptyFieldsModalVisible(false)} style={styles.errorModalButton}>
                        <Text style={styles.buttonText}>Cerrar</Text>
                    </TouchableOpacity>
                </View>
            </View>
...
emptyFieldsModalOverlay: {
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: 'rgba(0,0,0,0.5)',
},
emptyFieldsModalContent: {
    backgroundColor: '#FFF',
    borderRadius: 8,
    padding: 20,
    width: '80%',
